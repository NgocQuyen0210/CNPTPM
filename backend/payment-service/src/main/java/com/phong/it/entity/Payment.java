...
public class Payment extends PanacheEntityBase {
    ...
    public Payment(Long id, Long orderId, String transactionId, String vnpTransactionNo, BigDecimal amount, String bankCode, PaymentStatus paymentStatus, String vnpResponseCode, String paymentInfo, LocalDateTime createdAt) {
        this.id = id;
