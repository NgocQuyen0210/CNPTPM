...
import com.phong.it.client.OrderServiceClient;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public String createPayment(PaymentRequestDTO request, String ipAddress) {
        ...
        // 2. Tìm kiếm thông tin đơn hàng gốc qua REST Client
        ApiResponse<OrderResponseDTO> orderResp = orderServiceClient.getOrderById(request.orderId());
        ...
        // 3. Kiểm tra xem đơn hàng này đã từng có bản ghi thanh toán nào chưa
        Payment payment = Payment.find("orderId", request.orderId()).firstResult();
    ...
    public Payment processReturn(Map<String, String> queryParams) {
        ...
        if (signValue.equals(vnpSecureHash)) {
            ...
            if ("00".equals(responseCode)) {
                ...
                try {
                    orderServiceClient.updateStatus(payment.getOrderId(), com.phong.it.entity.OrderStatus.PROCESSING);
                } catch (Exception e) {
                    // Ignore or log
                }
            } else {
