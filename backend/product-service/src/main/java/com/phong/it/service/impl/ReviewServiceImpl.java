...
public class ReviewServiceImpl implements ReviewService {
    ...
    public ReviewResponseDTO create(Long userId, ReviewRequestDTO requestDTO) {
        ...
        UserResponseDTO user = userResponse.data();

        Review review = reviewMapper.toEntity(requestDTO);
        review.setProduct(product);
        review.setUserId(userId);
        review.setUserFullName(user.fullName());
    ...
    public void delete(Long userId, Long id) {
        ...
        UserResponseDTO currentUser = userResponse.data();

        boolean isAdmin = currentUser.roles().stream()
